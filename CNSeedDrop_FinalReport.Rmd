...
Our methods are similar to those of Research Question 2. Again, we use partial F-tests and AIC/BIC analyses for model selection, though there was no need to log-transform seed width. First, we analyze the fit of the four basic models - `Mowing Only`, `Warming Only`, `Warming and Mowing`, and `Interaction` - to identify which model fits the data best. 
